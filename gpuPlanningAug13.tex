...
the matrix explicit methods~\cite{Muller2013,Knepley2014,Medina2014}.
...
\else
\begin{tabular}{ccc}
\scalebox{0.26}{\includegraphics*{\picdir/OverviewApplicator}}  
&
...
shown left and right; respectively. The optical parameters, $\mu_\textit{eff}$,
